...
alter table BUSINESS_BACKGROUND add constraint fk_linkedin_owner_id foreign key (linkedin_owner_id) references LINKEDIN_OWNER(id) on delete restrict on update restrict;
...
alter table ACADEMIC_BACKGROUND add constraint fk_linkedin_owner_id foreign key (linkedin_owner_id) references LINKEDIN_OWNER(id) on delete restrict on update restrict;
